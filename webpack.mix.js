...
mix.copyDirectory('resources/assets/templates/tabler/dist/assets/css', 'public/assets/css')
    ...
    .copyDirectory('resources/assets/plugins/font-awesome/4.7.0/css', 'public/assets/plugins/font-awesome/4.7.0/css')
    .copyDirectory('resources/assets/plugins/font-awesome/4.7.0/fonts', 'public/assets/plugins/font-awesome/4.7.0/fonts')
    .copyDirectory('resources/assets/plugins/sweetalert2/8.9.0/dist', 'public/assets/plugins/sweetalert2/8.9.0/dist')
    .copyDirectory('resources/assets/plugins/source-sans-pro', 'public/assets/plugins/source-sans-pro')
